...
class Finances(models.Model):
    ...
    time_paid = models.CharField(max_length=50, null=True, blank=True)
...
class StatusRec(models.Model):
    ...
    stat_time = models.CharField(max_length=50, null=True, blank=True)
...
class Documents(models.Model):
    ...
    doc_time = models.CharField(max_length=100,null=True, blank=True)
