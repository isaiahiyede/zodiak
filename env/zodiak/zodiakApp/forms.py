...
class JobForm(forms.ModelForm):
    class Meta:
        ...
        fields = (
            ...
            'job_doc_3','job_comment', 'job_in_transit',
            ...
            'handling_info', 'value_for_carriage', 'number_of_pieces_to_ship','gross_weight', 'chargeable_rate', 'note_on_the_package', 'nature_and_quantity_of_goods', 'airline_tracking_number',
